...
${MYSQL_EXEC} "REPLACE INTO core_config_data SET value = '1', path ='fl32_loginas/controls/customer_form_button'"
${MYSQL_EXEC} "REPLACE INTO core_config_data SET value = '1', path ='fl32_loginas/controls/orders_grid_action'"
${MYSQL_EXEC} "REPLACE INTO core_config_data SET value = '1', path ='fl32_loginas/logs_cleanup/enabled'"
${MYSQL_EXEC} "REPLACE INTO core_config_data SET value = '30', path ='fl32_loginas/logs_cleanup/days_old'"
